...
Изменения:
1-сохранение конфигурации связи в файле на диске, что дает возможность при последующем открытии симулятора не заботится о параметрах настройки.
