...
Изменения:
- Добавлена практическая работа №17. Задвижки (управление электромагнитным пускателем).  
- Если при авто-обновлении возникли проблемы или ошибки, то воспользуйтесь инсталляционной версией.  
- .  
- .  
